/**
 * Frontend test case metadata — browser interaction format.
 * IDs match backend testCases/scenario1.js and scenario2.js.
 *
 * Step types used by testRunner.js:
 *   fill          → page.fill(selector, value)
 *   click         → page.click(selector)
 *   press         → page.press(selector, key)
 *   expect        → toHaveCount(n) | toContainText(text) | toHaveClass(cls)
 *   expectVisible → toBeVisible()
 *   expectHidden  → toHaveCount(0)
 */

export const SCENARIO_1_TESTS = [
    {
        id: 'tc-s1-1',
    ...
    },
    {
        ...
        action: {
            ...
            steps: [
                ...
                { do: 'click', selector: '[data-testid="add-btn"]' },
                { do: 'click', selector: '[data-testid="delete-btn"]' },  // deletes first
    ...
    },
    {
        ...
        action: {
            ...
            steps: [
                ...
                { do: 'fill',  selector: '[data-testid="todo-input"]', value: 'B' },
                { do: 'click', selector: '[data-testid="add-btn"]' },
                // Click toggle on FIRST item only
