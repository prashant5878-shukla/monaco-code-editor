...
export const EDITOR_FONT_FAMILY = "'JetBrains Mono','Fira Code',Consolas,monospace";
...
full CRUD operations.`,
    ...
    testCaseIds: ['tc-s1-1', 'tc-s1-2', 'tc-s1-3', 'tc-s1-4', 'tc-s1-5', 'tc-s1-6'],
  },
...
export const TEST_CASES = {
  ...
  'tc-s1-1': {
    ...
    description: 'Before any todos are created, GET /api/todos should return []',
  },
  'tc-s1-2': {
    id: 'tc-s1-2',
    scenarioId: 'todo-api-s1',
